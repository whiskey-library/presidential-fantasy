...
export const SEED_EVENTS: GameEvent[] = [
  {
    ...
    weight: 3,
    briefing:
      "The confetti's swept up and the desk is yours. Your team needs a signal: what's the message of the opening act? Every camera in the world is pointed at you.",
    choices: [
      {
        id: "ambition",
        ...
        result:
          "You roll out an ambitious 100-day blueprint. The base is electrified; the opposition is already drawing battle lines.",
        news: [
          { outlet: "tribune", headline: "A NEW DAWN: President unveils boldest agenda in a generation", tone: "positive" },
          { outlet: "beacon", headline: "New administration promises sweeping change; analysts question price tag", tone: "neutral" },
          { outlet: "ledger", headline: "Reckless overreach on day one, critics warn", tone: "negative" },
          { outlet: "buzz", headline: "POTUS comes out SWINGING — Washington in CHAOS already", tone: "neutral" },
        ],
        social: [
          { handle: "@hope_2_change", text: "FINALLY someone who means it 🙌", sentiment: "positive", clout: "44k" },
          { handle: "@fiscal_hawk", text: "and who exactly is paying for all this", sentiment: "negative" },
        ],
        advisor: "Bold. The honeymoon won't last — let's bank that approval before it cools.",
      },
      {
        id: "steady",
        ...
        result:
          "You strike a measured, unifying tone. Markets settle, allies relax, and the establishment exhales. The base wanted more fireworks.",
        news: [
          { outlet: "beacon", headline: "President opens with a steady hand, calls for unity", tone: "positive" },
          { outlet: "ledger", headline: "A reassuringly grown-up start, even opponents admit", tone: "positive" },
        ...
        social: [
          ...
          { handle: "@frustrated_left", text: "we didn't elect you to keep things the same", sentiment: "negative" },
        ],
...

  {
    ...
    category: "economy",
    title: "The Jobs Report Lands With a Thud",
    source: "Treasury Secretary",
    briefing:
      "Hiring stalled and the markets are jittery. Treasury wants a trillion-dollar jobs package on your desk. The deficit hawks are already circling.",
    choices: [
      {
        id: "spend",
        ...
        result:
          "Money flows into infrastructure and green factories. Job numbers tick up within the quarter — but the debt clock spins faster.",
        news: [
          { outlet: "tribune", headline: "President delivers: massive jobs bill becomes law", tone: "positive" },
        ...
        social: [
          { handle: "@union_steel", text: "my plant is hiring again. thank you.", sentiment: "positive", clout: "12k" },
          { handle: "@deficit_doom", text: "your grandkids will pay for this", sentiment: "negative" },
        ],
        advisor: "The economy needed the jolt. Just be ready when inflation hawks come knocking.",
      },
      {
        id: "targeted",
        ...
        result:
          "You negotiate a smaller, surgical package. Both sides grumble but sign. Growth is modest; fiscal credibility intact.",
        news: [
          { outlet: "beacon", headline: "Pared-down stimulus clears Congress in rare bipartisan vote", tone: "positive" },
        ...
        social: [
          ...
          { handle: "@laid_off_lee", text: "targeted means it's not targeting ME", sentiment: "negative" },
        ],
      ...
      },
      {
        ...
        result:
          "You hold the line on spending. The deficit holds steady; so does unemployment. The pain is real and it's got your name on it.",
        news: [
        ...
        advisor: "Principled — and politically expensive. Hope the recovery comes before the midterms.",
      },
    ],
  },

  {
    ...
    category: "foreign",
    title: "An Ally Asks for Weapons",
    source: "Secretary of State",
    briefing:
      "A democratic ally on the border of a hostile power is under pressure and quietly requesting advanced weapons. Send them, and you provoke the rival. Refuse, and you blink.",
    choices: [
      {
        id: "arm",
        ...
        result:
          "The shipment goes through. Your ally is grateful and emboldened; the rival summons your ambassador and rattles its saber.",
        news: [
          { outlet: "ledger", headline: "Peace through strength: President stands with allies", tone: "positive" },
          { outlet: "beacon", headline: "Arms deal approved; tensions with rival escalate", tone: "neutral" },
        ...
        advisor: "Allies will trust you more after this. Keep a back-channel open to the rival.",
      },
      {
        id: "diplomacy",
        ...
        result:
          "You convene emergency talks and broker a fragile ceasefire-for-now. No one's thrilled, but no one's shooting either.",
        news: [
          { outlet: "beacon", headline: "President brokers tense de-escalation talks", tone: "positive" },
        ...
        advisor: "A win for the patient approach. Fragile, though — one spark could undo it.",
      },
    ],
  },

  {
    ...
    category: "crisis",
    title: "Category 5 Makes Landfall",
    source: "FEMA Director",
    weight: 2,
    briefing:
      "A monster storm has flattened a coastal state. Power's out for millions, the death toll is climbing, and the governor — from the opposing party — is begging for federal help on live TV.",
    choices: [
      {
        id: "allhands",
        ...
        result:
          "You declare a major disaster, surge federal resources, and land in the wreckage by morning in shirtsleeves. The images define your presidency for a week.",
        news: [
          { outlet: "beacon", headline: "President leads massive relief effort, visits devastated coast", tone: "positive" },
        ...
        social: [
          { handle: "@gulf_resident", text: "the trucks actually came. i'm crying.", sentiment: "positive", clout: "210k" },
      ...
      },
      {
        ...
        result:
          "You run a tight operation from the Situation Room and let the agencies do their jobs. It's efficient. It's also invisible, and the absence gets noticed.",
        news: [
          ...
          { outlet: "tribune", headline: "Where is the president while a state drowns?", tone: "negative" },
        ...
        social: [
          ...
          { handle: "@storm_survivor", text: "would've been nice to see you care", sentiment: "negative" },
        ],
...

  {
    ...
    category: "scandal",
    title: "A Damaging Leak Hits the Press",
    source: "White House Counsel",
    minDay: 120,
    weight: 2,
    briefing:
      "Someone leaked internal memos suggesting a top appointee steered a contract to a friend. It's not you — but it's your administration, and the press smells blood.",
    choices: [
      {
        id: "transparent",
        ...
        result:
          "You release the documents, accept a resignation, and call for an independent review. The story burns hot for 48 hours, then starves.",
        news: [
          { outlet: "beacon", headline: "President moves quickly, releases documents, accepts resignation", tone: "positive" },
          ...
          { outlet: "buzz", headline: "POTUS throws appointee UNDER THE BUS — savage!", tone: "neutral" },
        ],
        social: [
      ...
      },
      {
        ...
        result:
          "You call it a partisan witch hunt and refuse to comment. The leaks keep coming. The story metastasizes into a weeks-long siege.",
        news: [
          { outlet: "tribune", headline: "COVER-UP? White House stonewalls as questions mount", tone: "negative" },
          { outlet: "beacon", headline: "President declines to address allegations; pressure builds", tone: "negative" },
...

  {
    ...
    minDay: 90,
    briefing:
      "A breakthrough AI is automating millions of jobs overnight. Labor wants a freeze; the tech sector says regulation will hand the future to rivals abroad. Everyone wants an answer today.",
    choices: [
      {
        id: "regulate",
        ...
        result:
          "You sign sweeping AI safety rules and a worker-transition fund. Unions cheer; Silicon Valley grumbles about moving overseas.",
        news: [
          ...
          { outlet: "ledger", headline: "Heavy-handed rules risk ceding the AI race", tone: "negative" },
        ...
        social: [
          ...
          { handle: "@vc_visionary", text: "innovation just moved to another country", sentiment: "negative" },
        ],
      ...
      },
      {
        ...
        result:
          "You pour public money into AI and slash red tape. Investment floods in and the markets soar — as a wave of layoffs rolls across the heartland.",
        news: [
...

  {
    ...
    weight: 2,
    briefing:
      "Intelligence flags a credible plot tied to a foreign cell. You can authorize a risky covert strike to take out the planner — or work it through allies and the courts. The clock is short.",
    choices: [
      {
        id: "strike",
        ...
        result:
          "The operation succeeds. The threat is neutralized and you address the nation. Civil-liberties groups and a couple of allies want to know exactly what you authorized.",
        news: [
          { outlet: "ledger", headline: "Decisive: President orders strike, eliminates threat", tone: "positive" },
          { outlet: "beacon", headline: "Covert operation neutralizes plot; legality debated", tone: "neutral" },
      ...
      },
      {
        ...
        result:
          "A coordinated, lawful operation rolls up the cell over several days. Slower, cleaner, and easier to defend — if nothing slips through the cracks first.",
        news: [
          { outlet: "tribune", headline: "By the book: President opts for lawful counterterror op", tone: "positive" },
          { outlet: "beacon", headline: "Multinational operation disrupts plot through proper channels", tone: "positive" },
...

  {
    ...
    title: "The Pipeline Decision",
    source: "Interior Secretary",
    briefing:
      "A massive energy pipeline awaits your signature. It means tens of thousands of jobs and lower prices — over the objections of tribes, farmers, and climate scientists camped along the route.",
    choices: [
      {
        id: "approve",
        ...
        result:
          "Construction begins within weeks. Gas prices ease and hard-hats cheer; the protest camps swell and the lawsuits pile up.",
        news: [
          { outlet: "ledger", headline: "Energy independence advances as president greenlights pipeline", tone: "positive" },
      ...
      },
      {
        ...
        result:
          "You block the pipeline and redirect funds to renewables. The world applauds and the protesters go home — as energy prices tick up and the trades feel abandoned.",
        news: [
          { outlet: "tribune", headline: "Historic: president halts pipeline, pivots to clean energy", tone: "positive" },
          { outlet: "beacon", headline: "Pipeline rejected; energy costs and job losses in focus", tone: "neutral" },
          { outlet: "ledger", headline: "Ideology over jobs: president kills thousands of paychecks", tone: "negative" },
...

  {
    ...
    minDay: 150,
    briefing:
      "Your signature healthcare bill is one vote short. A wavering senator will flip — for a pricey hospital earmark in their state. Take the deal, or hold the line on principle?",
    choices: [
      {
        id: "deal",
        ...
        result:
          "The earmark seals the vote and your bill becomes law. Millions gain coverage. The opposition gleefully reads the pork line-item aloud on cable.",
        news: [
          { outlet: "tribune", headline: "Landmark healthcare law expands coverage to millions", tone: "positive" },
          { outlet: "beacon", headline: "Healthcare bill passes after last-minute deal-making", tone: "neutral" },
      ...
      },
      {
        ...
        result:
          "You won't trade pork for the vote. The bill dies one short. You keep your hands clean and your signature achievement on the shelf.",
        news: [
          { outlet: "ledger", headline: "President refuses to deal; clean hands, dead bill", tone: "neutral" },
          { outlet: "beacon", headline: "Healthcare push collapses one vote short", tone: "negative" },
...

  {
    ...
    weight: 1,
    briefing:
      "The Pentagon confirms an unidentified craft has been parked over the capital for six hours, ignoring every signal. The footage has already leaked. The world is waiting for you to say something.",
    choices: [
      {
        id: "calm",
        ...
        result:
          "You go on air, steady and serious, promising transparency and no panic. The craft drifts off by dawn. Your composure becomes the story.",
        news: [
          { outlet: "beacon", headline: "President urges calm amid unexplained aerial event", tone: "positive" },
      ...
      },
      {
        ...
        result:
          "Fighters streak across the capital on live TV. The craft vanishes — but so does any sense of calm. Allies want to know why you nearly started a shooting war with the unknown.",
        news: [
          { outlet: "ledger", headline: "President answers mystery with force, jets scrambled", tone: "neutral" },
          { outlet: "beacon", headline: "Military response to aerial object rattles capital", tone: "neutral" },
  ...
  // ── Evergreen fillers (can recur so the game never stalls) ───────────────
  {
    ...
    weight: 1,
    briefing:
      "It's been a quiet stretch, and the briefing room is restless. The press corps wants a sit-down. How do you spend the spotlight?",
    choices: [
      {
        id: "tout",
        ...
        result:
          "You command the room, rattle off wins, and dodge the curveballs with a grin. The clips play well on the evening news.",
        news: [
...

  {
    ...
    category: "foreign",
    title: "A Routine Summit, A Tricky Photo",
    source: "Protocol Office",
    once: false,
    weight: 1,
    minDay: 100,
    briefing:
      "You're at a multinational summit. A controversial leader extends a hand for the cameras. The whole world is watching the body language.",
    choices: [
      {
        id: "shake",
        ...
        result:
          "You shake firmly and say little. Channels stay open; critics back home circulate the photo within minutes.",
        news: [
          { outlet: "beacon", headline: "President shakes hands with controversial leader at summit", tone: "neutral" },
      ...
      },
      {
        ...
        result:
          "You offer a curt nod and move on. The base roars approval; the snubbed leader's government issues an icy statement.",
        news: [
          { outlet: "tribune", headline: "President refuses to legitimize controversial leader", tone: "positive" },
          { outlet: "buzz", headline: "ICE COLD: POTUS leaves leader HANGING 🥶", tone: "positive" },
        ],
